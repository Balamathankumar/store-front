...
const ProductDetail: React.FC = () => {
  ...
  // Mock product images (in a real app, these would come from the API)
  const productImages = [
    '🏷️', // Default emoji as main image
    '📦', // Package view
    '🔍', // Close-up view
  ];
          ...
          <div className="main-image-container">
            <div 
              ...
              style={{
                width: '100%',
                height: '350px',
                background: 'linear-gradient(135deg, #F3E8DE, #EBD9C8)',
                borderRadius: '20px',
                display: 'flex',
                alignItems: 'center',
            ...
            {productImages.map((img, index) => (
              ...
              >
                <span className="thumbnail-content">
                  {index === 0 ? getProductEmoji(product) : img}
                </span>
              </button>
            ))}
          </div>
        ...
        <div className="related-products-section">
          ...
          <div className="related-products-grid">
            {relatedProducts.map((relatedProduct) => (
              ...
              >
                <div className="related-product-emoji">
                  {getProductEmoji(relatedProduct)}
                </div>
