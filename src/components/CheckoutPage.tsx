...
const CheckoutPage: React.FC = () => {
  ...
  useEffect(() => {
    if (items.length === 0 && !orderSuccess) {
      // Small delay to prevent immediate redirect during state updates
  ...
  const handleWeightChange = (productId: number, oldWeight: WeightOption, newWeight: WeightOption) => {
      ...
      <div className="checkout-page">
        ...
        <div className="checkout-container">
          ...
          <div style={{ 
            ...
            <h1 style={{ marginBottom: '16px', fontSize: '28px' }}>Your cart is empty</h1>
      ...
      <div className="checkout-page">
        ...
        <div className="checkout-container">
          ...
          <div className="order-success" style={{ 
            ...
            <div style={{ fontSize: '72px', marginBottom: '20px' }}>✅</div>
            <h1 style={{ color: 'var(--accent-green)', marginBottom: '16px', fontSize: '28px' }}>
            ...
            <p style={{ marginBottom: '32px', color: '#666', fontSize: '16px' }}>
              You will receive a confirmation email shortly. We'll start preparing your order right away!
            </p>
      ...
      <div className="checkout-container">
        ...
        <div className="checkout-content">
          ...
          <div className="checkout-form">
            <h1 style={{ fontSize: '32px', marginBottom: '24px', color: 'var(--text-dark)' }}>
              Checkout
            </h1>
            ...
            <form onSubmit={handleSubmit}>
              ...
              <div className="form-section" style={{ 
                ...
                <h3 style={{ marginBottom: '20px', fontSize: '20px', color: 'var(--text-dark)' }}>
                  Customer Information
                </h3>
            ...
            <div style={{ 
              ...
              <div style={{ marginBottom: '20px' }}>
                {items.map((item) => {
                  ...
                  return (
                    <div key={`${item.id}-${item.weight}`} className="cart-item-edit" style={{ 
                      background: 'var(--warm-beige-100)',
                      padding: '16px',
                      borderRadius: '8px',
                      marginBottom: '16px'
                      ...
                      <div style={{ display: 'flex', gap: '12px', marginBottom: '12px' }}>
                        ...
                        <div style={{ flex: 1 }}>
                          <h4 style={{ fontSize: '16px', marginBottom: '4px', fontWeight: 'bold' }}>
                            {item.product.name}
                          </h4>
                          <p style={{ fontSize: '14px', color: '#666', marginBottom: '8px' }}>
                            ₹{itemPrice} per {item.weight}g
                          </p>
                          <p style={{ fontSize: '16px', fontWeight: 'bold', color: 'var(--brand-brown)' }}>
                            Total: ₹{itemTotal}
                          </p>
                        </div>
                        <button 
                          onClick={() => handleRemoveItem(item.id, item.weight as WeightOption)}
                            ...
                            >
                              {getAvailableWeights().map(weight => (
                                <option key={weight} value={weight}>
                                  {weight}g - ₹{getItemPrice(item.product!, weight)}
                                </option>
                              ))}
                            </select>
                          </div>
                        ...
                        {item.product.isCombo && (
                          <div style={{
                            ...
                            <div style={{
                              ...
                              Fixed combo with {item.product.items?.length || 0} items
                            </div>
                          </div>
                        )}
              ...
              <div style={{ borderTop: '1px solid #f0f0f0', paddingTop: '16px' }}>
                ...
                <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: '8px' }}>
                  <span>Shipping</span>
                  <span style={{ color: shippingCost === 0 ? 'var(--accent-green)' : 'inherit' }}>
              ...
              <div style={{ 
                ...
                <h4 style={{ marginBottom: '12px', fontSize: '16px' }}>Delivery Information</h4>
