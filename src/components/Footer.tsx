          ...
          <div className="footer-grid">
            ...
            <div className="footer-section">
              ...
              <p className="footer-description">
                Your premium destination for authentic spices, nuts, herbs, and blends. 
                We bring you the finest quality ingredients from around the world.
              </p>
            ...
            <div className="footer-section">
              ...
              <ul className="footer-links">
                ...
                <li><a href="/?category=blends">Blends</a></li>
              </ul>
            </div>
            ...
            <div className="footer-section">
              ...
              <p className="newsletter-text">
                Subscribe to get special offers, recipes, and new product updates.
              </p>
